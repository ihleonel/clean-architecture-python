...
class TestCreateCustomer(TestCase):
    ...
    def test_should_create_customer(self):
        self.customer_repository_mock.already_exists_email.return_value = False
        ...
        self.customer_repository_mock.already_exists_email.assert_called_once_with("leonel.ruiz@gmail.com")
    ...
    def test_should_not_create_customer_with_duplicated_email(self):
        self.customer_repository_mock.already_exists_email.return_value = True
